...
async function main() {
    ...
    await raceResultService.saveToFile("./EX-3/data/raceScores.json");

    // Write the total time for participant 1
    const total = raceResultService.getTotalTimeForParticipant("participant1");
    console.log(total.toString());       // Expected : 4m 15s  
}   
main();
